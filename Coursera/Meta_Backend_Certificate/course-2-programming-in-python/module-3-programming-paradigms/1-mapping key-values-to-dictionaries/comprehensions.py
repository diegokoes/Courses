...
def generate_usernames(mod_list):
    ...
    """
    ### WRITE YOUR CODE HERE ###
    list_underscored = [el.replace(" ", "_") for el in mod_list]
    return list_underscored
...
def map_id_to_initial(employee_list):
    ...
    """
    ### WRITE YOUR CODE HERE ###
    ### ! 30 MINUTES TO NOTICE THAT I WAS TRYING TO DO A LIST COMPREHENSION FOR A
    ### ! DICTIONARY, [] INSTEAD OF [] I WON'T FORGET THIS AT LEAST
    dictionary_id_initial = {
        dictionary["name"][0]: dictionary["id"] for dictionary in employee_list
    }
    return dictionary_id_initial
